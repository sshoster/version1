package com.bridge.debate.agreements.application

import com.bridge.debate.agreements.domain.ApprovalDecision
import com.bridge.debate.agreements.domain.ApprovalRecord
import com.bridge.debate.agreements.domain.OutcomeArtifact
import com.bridge.debate.agreements.domain.OutcomeArtifactRepository
import com.bridge.debate.agreements.domain.OutcomeType
import com.bridge.debate.agreements.domain.ProposalStatus
import com.bridge.debate.agreements.domain.UnderstandingBlock
import com.bridge.debate.agreements.infrastructure.ApprovalRepository
import com.bridge.debate.agreements.infrastructure.ApprovalRequestRepository
import com.bridge.debate.agreements.infrastructure.ProposalRepository
import com.bridge.debate.agreements.infrastructure.ProposalVersionRepository
...
import com.bridge.debate.notifications.application.EmailAttachment
import com.bridge.debate.notifications.application.EmailDispatcher
        ...
        proposals.findByRoomIdOrderByCreatedAtDesc(roomId)
            ...
            .mapNotNull { proposal ->
                val request = approvalRequests
                    .findByProposalIdAndStatus(proposal.id, com.bridge.debate.agreements.domain.ApprovalRequestStatus.APPROVED)
