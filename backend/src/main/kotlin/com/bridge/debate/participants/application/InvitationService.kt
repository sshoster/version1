...
import com.bridge.debate.notifications.application.InvitationNotifier
...
import com.bridge.debate.participants.infrastructure.InvitationRepository
...
class InvitationService(
    ...
    private val userDirectory: com.bridge.debate.identity.application.UserDirectory,
    private val joinRequests: com.bridge.debate.participants.domain.JoinRequestRepository,
    ...
    fun publicInfo(rawToken: String): InvitationPublicInfo {
        ...
        val inviter = participants.findByRoomIdAndUserIdAndStatus(
            invitation.roomId, invitation.createdByUserId, com.bridge.debate.participants.domain.ParticipantStatus.ACTIVE,
        )
    ...
    fun accept(rawToken: String, actor: AuthenticatedUser): String {
        ...
        if (directory.activeParticipant(invitation.roomId, actor.userId) != null) {
            throw com.bridge.debate.shared.errors.ApiException(
                409, "ALREADY_MEMBER",
        ...
        joinRequests.findByRoomIdAndUserIdAndStatus(
            invitation.roomId, actor.userId, com.bridge.debate.participants.domain.JoinRequestStatus.PENDING,
