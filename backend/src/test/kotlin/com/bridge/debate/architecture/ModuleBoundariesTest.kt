package com.bridge.debate.architecture
...
class ModuleBoundariesTest {
    ...
    private val importedClasses = ClassFileImporter()
        ...
        .importPackages("com.bridge.debate")
    ...
    fun `domain layers do not depend on application, api, or infrastructure layers`() {
        noClasses().that().resideInAPackage("com.bridge.debate..domain..")
            .should().dependOnClassesThat()
            .resideInAnyPackage(
                "com.bridge.debate..application..",
                "com.bridge.debate..api..",
                "com.bridge.debate..infrastructure..",
            )
    ...
    fun `controllers live only in api packages`() {
        classes().that().areAnnotatedWith(org.springframework.web.bind.annotation.RestController::class.java)
            .should().resideInAPackage("com.bridge.debate..api..")
            .check(importedClasses)
    }
    ...
    fun `no module reaches into another module's infrastructure`() {
        modules.forEach { module ->
            noClasses().that().resideOutsideOfPackage("com.bridge.debate.$module..")
                .should().dependOnClassesThat()
                .resideInAPackage("com.bridge.debate.$module.infrastructure..")
